...
class Solution : public IExecutionsListener
{
 ...
 public:
  ...
  static JobStretchVec calculateJobTStretchVec(const SolutionVec& solution, std::vector<JobSP> jobs);
  static JobStretchVec calculateJobMStretchVec(const SolutionVec& solution, std::vector<JobSP> jobs);
  static JobStretchVec calculateJobWStretchVec(const SolutionVec& solution, std::vector<JobSP> jobs, std::shared_ptr<Machines>);
